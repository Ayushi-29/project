    ...
    <div class="container-fluid row text-center">
        <div class="col-md-4">
            <div class="card" style="background:transparent;border:none;">
                ...
                <div class="card-body">Contact Number : <br><b>7049795409</b></div>
                <div class="card-body">                 <br><b>9993860140</b></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card" style="background:transparent;border:none;">
            <img class="" src="images/mail.jfif" width=200 style="margin-left:30%;border-radius:2000px;">
                ...
                <div class="card-body">Email : <br><b>agrawalayushi321@gmail.com</b></div>
                <div class="card-body">        <br><b>nishakiran26@gmail.com</b></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card" style="background:transparent;border:none;">
